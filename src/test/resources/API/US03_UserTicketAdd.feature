...
Feature: US03 - As a user, I want to be able to create a new user ticket record through API connection.
  ...
  Scenario:TC04-User ticket POST request with invalid authorization information and correct data test
  ...
  Scenario Outline:TC05-User ticket GET request test to verify that new record has been created
