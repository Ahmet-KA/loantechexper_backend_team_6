...
public class DB_Manage {
    ...
    //Burhan
    private static String CronSchedulesAmountQuery = "select name from cron_schedules limit 2;";

    public static String getCronSchedulesAmountQuery() {
        return CronSchedulesAmountQuery;
    }

    private static String depositsAmount = "select charge from deposits where trx='4GC9SMZUS69S' and amount<500; ";

    public static String getDepositsAmount() { return depositsAmount;
    }

    private static String deviceTokens = "insert into device_tokens (is_app,token,user_id) values (1,'B381461',5);";
