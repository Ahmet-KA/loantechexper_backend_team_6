...
public class API_Stepdefinitions {
    ...
    public void itIsVerifiedThatTheCreatedRecordHasBeenDeletedBySendingADELETERequestToTheApiLoanplansDeleteIdEndpointWithTheAddedPlanIdReturnedInTheResponseBody() {
    ...
    public void itMustBeVerifiedThatTheMessageInformationInTheResponseBodyIs(String message) {
    ...
    public void api_kullanicisi_donen_response_u_gecerli_authorization_bilgisi_ile_kaydeder() {
        response = given()
                .spec(spec)
                .header("Accept", "application/json")
                .headers("Authorization", "Bearer " + Authentication.createToken("admintoken"))
    ...
    public void api_kullanicisi_patch_request_gonderir_ve_donen_response_u_gecersız_authorization_bilgisi_ile_kaydeder(int status, String message) {
        try {
            response = given()
                    .spec(spec)
                    .header("Accept", "application/json")
    ...
    public void closeOlaniResponseDaDonenBilgileriniUser_idNameEmailTicketSubjectStatusPriorityLast_replyCreated_atUpdated_atDogrulayiniz() {
    ...
    public void endpointEGecerliAuthorizationBilgileriIleBirGETRequestGonderilirKayitEdilir() {
    ...
    public void api_kullanicisi_get_request_gonderir_ve_donen_response_u_gecerli_authorization_bilgisi_ile_kaydeder() {
        response = given()
                .spec(spec)
                .header("Accept", "application/json")
                .headers("Authorization", "Bearer " + Authentication.createToken("admintoken"))
    ...
    public void api_kullanicisi_get_request_gonderir_ve_donen_response_u_gecersız_authorization_bilgisi_ile_kaydeder(int status, String message) {
        try {
            response = given()
                    .spec(spec)
                    .header("Accept", "application/json")
    ...
    public void api_kullanicisi_response_body_deki_data_message_bilgisinin_oldugu_dogrulanmali(String message) {
        jsonPath = response.jsonPath();
        response.then().assertThat().body("data.message", Matchers.equalTo(message));
    }
    ...
    public void the_api_user_prepares_a_post_request_containing_the_correct_data_to_send_to_the_user_ticket_add_endpoint() {
   /*
    {
   ...
   */   //id 184
    ...
    public void the_api_user_sends_a_post_request_and_saves_the_response_from_the_user_ticket_add_endpoint_with_valid_authorization_information() {
        response= given()
    ...
    public void the_api_user_prepares_a_post_request_containing_no_data_to_send_to_the_user_ticket_add_endpoint() {
        requestBody=new JSONObject();
    }

    @Given("The API user prepares a POST request with incomplete missing data to send to the user ticket add endpoint")
    public void the_api_user_prepares_a_post_request_with_incomplete_missing_data_to_send_to_the_user_ticket_add_endpoint() {
        requestBody=new JSONObject();
        requestBody.put("subject", "Blue Test Ticket");
    }
    ...
    public void the_api_user_sends_a_post_request_and_saves_the_response_from_the_user_ticket_add_endpoint_with_invalid_authorization_information() {
        response= given()
                .spec(spec).contentType(ContentType.JSON)
                .header("Accept", "application/json")
    ...
    public void the_api_user_verifies_that_the_error_message_in_the_response_body_is(String errorMessage) {
    ...
    public void the_api_user_verifies_that_the_success_value_in_the_response_body_is_true() {
    ...
    public void The_api_user_sends_a_delete_request_to_delete_the_created_ticket_and_saves_the_response_from_the_user_ticket_delete_endpoint_with_valid_authorization_information() {
        jsonPath=response.jsonPath();
    ...
    public void the_api_user_saves_the_response_from_the_user_ticket_detail_id_endpoint_with_valid_authorization_information() {
        response = given()
                .spec(spec)
                .header("Accept", "application/json")
                .headers("Authorization", "Bearer " + Authentication.createToken("usertoken"))
    ...
    public void the_api_user_send_a_patch_request_and_saves_the_response_from_the_user_ticket_close_endpoint_with_valid_authorization_information() {
        response=given().spec(spec).header("Accept", "application/json")
                .headers("Authorization","Bearer "+Authentication.createToken("usertoken"))
                .when()
                .patch(fullPath);
    ...
    public void api_kullanicisi_api_withdraw_methods_add_endpointden_gelen_yaniti_gecerli_yetkilendirme_bilgileriyle_kaydeder() {
    ...
    public void endpoint_ine_gecerli_authorization_bilgileri_ve_dogru_id_iceren_bir_patch_body_gonderilir_ve_kaydedilir() {
    ...
    public void api_kullanicisi_body_deki_mesaj_bilgisinin_oldugunu_dogrular(String message) {
    ...
    public void endpoint_ine_gecerli_authorization_bilgileri_ve_dogru_id_icermeyen_bir_patch_body_gonderilir_ve_kaydedilir() {
    ...
    public void endpoint_ine_gecerli_authorization_bilgileri_ve_kaydi_olmayan_id_icermeyen_bir_patch_body_gonderilir_ve_kaydedilir() {
    ...
    public void endpoint_ine_gecersiz_authorization_bilgileri_ve_dogru_id_iceren_bir_patch_body_gonderilir_ve_kaydedilir_apı_kullanıcısı_durum_kodunun_olduğunu_doğrular_apı_kullanıcısı_response_body_deki_error_bilgisinin_oldugu_dogrulanmali(Integer int1, String string) {
        jsonPath = response.jsonPath();
        Integer id = jsonPath.getInt("data.Method.id");
        System.out.println("id = " + id);
        try {
    ...
    public void api_kullanicisi_guncellenen_id_icin_get_request_gonderir_ve_donen_response_u_gecerli_authorization_bilgisi_ile_kaydeder() {
        jsonPath = response.jsonPath();
        Integer id = jsonPath.getInt("data[\"Method id\"]");
        System.out.println("id = " + id);
        response = given()
    ...
    public void api_kullanicisi_api_subscriber_methods_add_endpointden_gelen_yaniti_gecerli_yetkilendirme_bilgileriyle_kaydeder() {
        response = given()
                .spec(spec).contentType(ContentType.JSON)
                .header("Accept", "application/json")
                .headers("Authorization", "Bearer " + Authentication.createToken("admintoken"))
    ...
    public void endpoint_ine_gecerli_authorization_bilgileri_ve_dogru_id_iceren_bir_delete_body_gonderilir_ve_kaydedilir() {
        jsonPath = response.jsonPath();
    ...
    public void endpoint_ine_gecerli_authorization_bilgileri_ile_bir_delete_body_gonderilir_ve_kaydedilir() {
    ...
    public void endpoint_ine_gecersiz_authorization_bilgileri_ve_dogru_id_iceren_bir_delete_body_gonderilir_ve_kaydedilir_api_kullanicisi_durum_kodunun_oldugunu_dogrular_api_kullanicisi_response_body_deki_error_bilgisinin_oldugu_dogrulanmali(Integer int1, String string) {
    ...
    public void endpoint_ine_gecerli_authorization_bilgileri_ve_dogru_id_iceren_bir_delete_body_gonderilir_ve_kaydin_silindigi_dogrulanir() {
        jsonPath = response.jsonPath();
    ...
    public void api_kullanicisi_api_loans_reject_id_endpointine_gondermek_icin_dogru_datalar_iceren_bir_post_request_hazirlar() {
        requestBody = new JSONObject();
    ...
    public void endpoint_ine_gecerli_authorization_bilgileri_ve_dogru_id_iceren_bir_post_body_gonderilir_ve_kaydedilir() {
        response = given()
                .spec(spec).contentType(ContentType.JSON
                )
                .header("Accept", "application/json")
    ...
    public void api_kullanicisi_body_deki_reason_bilgisinin_oldugunu_dogrular(String Reason) {
        response.then()
                .assertThat()
    ...
    public void api_kullanicisi_api_loans_reject_id_endpointine_gondermek_icin_dogru_datalar_icermeyen_bir_post_request_hazirlar() {
        requestBody = new JSONObject();
    ...
    public void endpoint_ine_gecersiz_authorization_bilgileri_ve_dogru_id_iceren_bir_post_body_gonderilir_ve_kaydedilir() {
    ...
    public void api_kullanicisi_body_deki_error_bilgisinin_oldugunu_dogrular(String string) {
        response.then()
                .assertThat()
    ...
    public void api_kullanicisi_body_deki_reason_bilgisinin_null_oldugunu_dogrular() {
        response.then()
                .assertThat()
    ...
    public void kullanciEndPointIneDogruDataalarIcerenBirPOSTBodyGonderir() {
...
//}
    ...
    public void kullanciEndPointIneEksikDataalarIcerenBirPOSTBodyGonderir() {
    ...
    public void kullanciEndPointIneGecersizAuthorizationBiilgileriIleBirPOSTBodyGonderir() {
    ...
    public void apiKullanicisiDonenPatchResponseGecersizAutorizationBilgisiIleKaydedipDurumKodununVeMesajinOldugunuDogrrular(int arg0, String arg1) {
    ...
    public void api_kullanicisiDonenResponseUGecerliAuthorizationBilgisiIleKaydeder() {
    ...
    public void the_api_user_verifies_that_the_status_information_in_the_response_boddy_is(int status) {
    ...
    public void idAlVeSilmeIsleminiGerceklestiginiOnayla() {
    ...
    public void api_kullanicisiResponseBodyDekiDataMessageBilgisininOlduguDogrulanmalig(String arg0) {
    ...
    public void api_kullanicisiDonenPATCHResponseUGecerliAuthorizationBilgisiIleKaydederr() {
    ...
    public void api_kullanicisi_post_request_gonderir_ve_donen_responsu_gecerli_authorization_bilgisi_ile_kaydeder() {
        response = given()
                .spec(spec)
                .contentType(ContentType.JSON)
                .header("Accept", "application/json")
    ...
    public void api_kullanicisi_bodysiz_post_request_gonderir_ve_donen_responsu_gecerli_authorization_bilgisi_ile_kaydeder() {
        response = given()
                .spec(spec)
                .header("Accept", "application/json")
                .headers("Authorization", "Bearer " + Authentication.createToken("admintoken"))
    ...
    public void api_kullanicisi_post_request_gonderir_ve_donen_response_u_gecersiz_authorization_bilgisi_ile_kaydeder(int status, String message) {
        try {
            response = given()
                    .spec(spec)
                    .contentType(ContentType.JSON)
    ...
    public void api_kullanicisi_delete_request_gonderir_ve_donen_response_u_gecerli_authorization_bilgisi_ile_kaydeder() {
    ...
    public void response_body_de_dondurulen_deleted_withdrawal_id_yi_kaydeder() {
        jsonPath = response.jsonPath();
    ...
    public void deleted_withdrawal_id_ile_get_request_gonderir() {
    ...
    public void deleted_withdrawal_id_ile_responsedan_donen_id_dogrulanir() {
        jsonPath = response.jsonPath();
